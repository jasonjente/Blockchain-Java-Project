...
public class BlocksData {
    ...
    public static BlockDTO getNextBlock(int id, String lastHash) {

        TransactionDTO transactionDTO = new TransactionDTO(id, timeStamps[id], customerIds[id], amounts[id]);

        List<TransactionDTO> transactionDTOS = new ArrayList<>();
        transactionDTOS.add(transactionDTO);
        BlockDTO nextBlock = new BlockDTO(lastHash, transactionDTOS);
        return nextBlock;
    }
